...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category, category_name in category_list:
...
def tag_special_ingredients(dish):
    ...
    """
    specials_ingredients_in_dish = set(dish[1]).intersection(SPECIAL_INGREDIENTS)
    return (dish[0], specials_ingredients_in_dish)
