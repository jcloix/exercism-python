...
def preparation_time_in_minutes(number_of_layers):
    ...
    total preparation time, assuming each layer takes 'PREPARATION_TIME' minutes.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Function that takes the number of layers and the time the lasagna has
    already spent baking and returns the sum of preparation time and
    baking time elapsed.
    """
